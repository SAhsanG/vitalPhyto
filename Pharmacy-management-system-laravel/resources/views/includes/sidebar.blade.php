	...
	<div class="sidebar-inner slimscroll">
		<div id="sidebar-menu" class="sidebar-menu">
			...
			<ul>
				...
				@endcan
                {{-- <li class="{{ Request::routeIs('add-customers') ? 'active' : '' }}">
					<a href="{{route('customers.create')}}"><i class="fe fe-layout"></i> <span>Customers</span></a>
				</li> --}}
                <li class="submenu">
					<a href="#"><i class="fe fe-user"></i> <span> Customers</span> <span class="menu-arrow"></span></a>
					<ul style="display: none;">
						<li><a class="{{ Request::routeIs('customers.index') ? 'active' : '' }}" href="{{route('customers.index')}}">Customers List</a></li>
						<li><a class="{{ Request::routeIs('customers.create') ? 'active' : '' }}" href="{{route('customers.create')}}">Add Customers</a></li>
					</ul>
				</li>
				@can('view-supplier')
				<li class="submenu">
